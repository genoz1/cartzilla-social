...
If the source is a roundup or list-style story naming multiple specific products (each with
a real brand and name), preserve as many of those real, specific named items as reasonably
fit in 3-5 paragraphs — don't collapse a 20-item roundup into a vague mention of just one or
two. If the source material doesn't name specific items for a "roundup" story, don't invent
placeholder ones — write generally about what the source actually says instead.
